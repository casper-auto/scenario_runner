...
class CasperAutoStopSign(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        super(CasperAutoStopSign, self).__init__("CasperAutoStopSign",
                                                  ego_vehicles,
                                                  config,
                                                  world,
                                                  debug_mode,
...
class CasperAutoStopSignWithObstacle(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        super(CasperAutoStopSignWithObstacle, self).__init__("CasperAutoStopSignWithObstacle",
                                                             ego_vehicles,
                                                             config,
                                                             world,
                                                             debug_mode,
